...
- `runbooks/` — failure playbooks keyed to Blueprint §9 failure rows (each row = one runbook, E6/E7 era).
- `permissions.md` — ADR-022 justifications (the install screen is the brand).
- Export-format covenant lands here at E5-T04 as `export-format-v1.md`.
